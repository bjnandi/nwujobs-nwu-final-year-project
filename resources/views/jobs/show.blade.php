      ...
      @endif
       ...
       <div class="row" id="app">
          ...
          <div class="col-lg-8">
            ...
            <div class="p-4 mb-8 bg-white">
              <h3 class="h5 text-black mb-3"><i class="fa fa-clock-o" style="color: blue;">&nbsp;</i>Type</h3>
              <p>{{$job->type}} </p>
              </div>
...
<h3><b>Job Recommendation</b></h3> 

<div class="row" id="app"> 
@foreach($jobRecommendations as $jobRecommendation)
<div class="card col-md-4 p-4 site-section bg-light" style="width: 15rem; margin-top:20px">

  <div class="card-body"> 
  <a href="{{route('jobs.show',[$jobRecommendation->id,$jobRecommendation->slug])}}"> <p class="badge badge-success">{{$jobRecommendation->type}}</p> </a>
   <a href="{{route('jobs.show',[$jobRecommendation->id,$jobRecommendation->slug])}}"> <h5 class="card-title">{{$jobRecommendation->position}}</h5></a>
